...
var AdminGuard = function () {
    ...
    var _classThis;
    var _classSuper = auth_guard_1.AuthGuard;
    var AdminGuard = _classThis = /** @class */ (function (_super) {
        __extends(AdminGuard_1, _super);
        function AdminGuard_1() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        AdminGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var canActivate, request;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, request.user.role === 'ADMIN'];
                    }
                });
            });
        };
