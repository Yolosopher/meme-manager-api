...
var AuthGuard = function () {
    ...
    var AuthGuard = _classThis = /** @class */ (function () {
        function AuthGuard_1(jwtService, tokenService) {
            this.jwtService = jwtService;
            this.tokenService = tokenService;
        }
        AuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var foundInDB, request, authorization, token, tokenPayload, authResult, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.tokenService.findToken(token)];
                        case 2:
                        ...
                        case 4:
                            error_1 = _a.sent();
                            if (!foundInDB) return [3 /*break*/, 6];
                            return [4 /*yield*/, this.tokenService.deleteToken(foundInDB.token)];
                        case 5:
                            _a.sent();
                            _a.label = 6;
                        case 6:
                            if (error_1 instanceof jwt_1.TokenExpiredError) {
