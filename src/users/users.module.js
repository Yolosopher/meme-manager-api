...
var hasher_module_1 = require("../hasher/hasher.module");
var token_module_1 = require("../token/token.module");
var UsersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [database_module_1.DatabaseModule, hasher_module_1.HasherModule, token_module_1.TokenModule],
    ...
    var UsersModule = _classThis = /** @class */ (function () {
        function UsersModule_1(usersService) {
            this.usersService = usersService;
        }
        UsersModule_1.prototype.onModuleInit = function () {
